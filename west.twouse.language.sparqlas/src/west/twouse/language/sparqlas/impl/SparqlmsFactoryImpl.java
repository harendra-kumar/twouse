 ...
 * @generated
 */
public class SparqlmsFactoryImpl extends EFactoryImpl implements SparqlmsFactory
{
  /**
   ...
   * @generated
   */
  public static SparqlmsFactory init()
  {
    try
    {
      SparqlmsFactory theSparqlmsFactory = (SparqlmsFactory)EPackage.Registry.INSTANCE.getEFactory("http://west.uni-koblenz.de/sparqlas"); 
      if (theSparqlmsFactory != null)
      {
        return theSparqlmsFactory;
      }
    }
    ...
    return new SparqlmsFactoryImpl();
  }
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case SparqlmsPackage.ONTOLOGY_DOCUMENT: return createOntologyDocument();
      case SparqlmsPackage.IMPORT: return createImport();
      case SparqlmsPackage.PREFIX_DEFINITION: return createPrefixDefinition();
      case SparqlmsPackage.SELECT_QUERY: return createSelectQuery();
      case SparqlmsPackage.CONSTRUCT_QUERY: return createConstructQuery();
      case SparqlmsPackage.ASK_QUERY: return createAskQuery();
      case SparqlmsPackage.DESCRIBE_QUERY: return createDescribeQuery();
      case SparqlmsPackage.FULL_IRI: return createFullIRI();
      case SparqlmsPackage.ABBREVIATED_IRI: return createAbbreviatedIRI();
      case SparqlmsPackage.CLASS_VARIABLE: return createClassVariable();
      case SparqlmsPackage.OBJECT_PROPERTY_VARIABLE: return createObjectPropertyVariable();
      case SparqlmsPackage.DATA_PROPERTY_VARIABLE: return createDataPropertyVariable();
      case SparqlmsPackage.INDIVIDUAL_VARIABLE: return createIndividualVariable();
      case SparqlmsPackage.CLASS: return createClass();
      case SparqlmsPackage.DATATYPE: return createDatatype();
      case SparqlmsPackage.OBJECT_PROPERTY: return createObjectProperty();
      case SparqlmsPackage.DATA_PROPERTY: return createDataProperty();
      case SparqlmsPackage.NAMED_INDIVIDUAL: return createNamedIndividual();
      case SparqlmsPackage.ANONYMOUS_INDIVIDUAL: return createAnonymousIndividual();
      case SparqlmsPackage.LITERAL_VARIABLE: return createLiteralVariable();
      case SparqlmsPackage.LITERAL: return createLiteral();
      case SparqlmsPackage.CLASS_ASSERTION: return createClassAssertion();
      case SparqlmsPackage.OBJECT_PROPERTY_ASSERTION: return createObjectPropertyAssertion();
      case SparqlmsPackage.DATA_PROPERTY_ASSERTION: return createDataPropertyAssertion();
      case SparqlmsPackage.NEGATIVE_OBJECT_PROPERTY_ASSERTION: return createNegativeObjectPropertyAssertion();
      case SparqlmsPackage.NEGATIVE_DATA_PROPERTY_ASSERTION: return createNegativeDataPropertyAssertion();
      case SparqlmsPackage.SAME_INDIVIDUAL: return createSameIndividual();
      case SparqlmsPackage.DIFFERENT_INDIVIDUALS: return createDifferentIndividuals();
      case SparqlmsPackage.SUB_CLASS_OF: return createSubClassOf();
      case SparqlmsPackage.EQUIVALENT_CLASSES: return createEquivalentClasses();
      case SparqlmsPackage.DISJOINT_CLASSES: return createDisjointClasses();
      case SparqlmsPackage.DISJOINT_UNION: return createDisjointUnion();
      case SparqlmsPackage.OBJECT_UNION_OF: return createObjectUnionOf();
      case SparqlmsPackage.OBJECT_COMPLEMENT_OF: return createObjectComplementOf();
      case SparqlmsPackage.OBJECT_ONE_OF: return createObjectOneOf();
      case SparqlmsPackage.OBJECT_INTERSECTION_OF: return createObjectIntersectionOf();
      case SparqlmsPackage.OBJECT_ALL_VALUES_FROM: return createObjectAllValuesFrom();
      case SparqlmsPackage.OBJECT_SOME_VALUES_FROM: return createObjectSomeValuesFrom();
      case SparqlmsPackage.OBJECT_HAS_VALUE: return createObjectHasValue();
      case SparqlmsPackage.OBJECT_MIN_CARDINALITY: return createObjectMinCardinality();
      case SparqlmsPackage.OBJECT_MAX_CARDINALITY: return createObjectMaxCardinality();
      case SparqlmsPackage.OBJECT_EXACT_CARDINALITY: return createObjectExactCardinality();
      case SparqlmsPackage.DATA_ALL_VALUES_FROM: return createDataAllValuesFrom();
      case SparqlmsPackage.DATA_SOME_VALUES_FROM: return createDataSomeValuesFrom();
      case SparqlmsPackage.DATA_HAS_VALUE: return createDataHasValue();
      case SparqlmsPackage.DATA_MIN_CARDINALITY: return createDataMinCardinality();
      case SparqlmsPackage.DATA_MAX_CARDINALITY: return createDataMaxCardinality();
      case SparqlmsPackage.DATA_EXACT_CARDINALITY: return createDataExactCardinality();
      case SparqlmsPackage.DATA_UNION_OF: return createDataUnionOf();
      case SparqlmsPackage.DATA_COMPLEMENT_OF: return createDataComplementOf();
      case SparqlmsPackage.DATA_ONE_OF: return createDataOneOf();
      case SparqlmsPackage.DATA_INTERSECTION_OF: return createDataIntersectionOf();
      case SparqlmsPackage.DATATYPE_RESTRICTION: return createDatatypeRestriction();
      case SparqlmsPackage.FACET_RESTRICTION: return createFacetRestriction();
      case SparqlmsPackage.SUB_OBJECT_PROPERTY_OF: return createSubObjectPropertyOf();
      case SparqlmsPackage.OBJECT_PROPERTY_CHAIN: return createObjectPropertyChain();
      case SparqlmsPackage.EQUIVALENT_OBJECT_PROPERTIES: return createEquivalentObjectProperties();
      case SparqlmsPackage.DISJOINT_OBJECT_PROPERTIES: return createDisjointObjectProperties();
      case SparqlmsPackage.OBJECT_PROPERTY_DOMAIN: return createObjectPropertyDomain();
      case SparqlmsPackage.OBJECT_PROPERTY_RANGE: return createObjectPropertyRange();
      case SparqlmsPackage.INVERSE_OBJECT_PROPERTY_ATOM: return createInverseObjectPropertyAtom();
      case SparqlmsPackage.FUNCTIONAL_OBJECT_PROPERTY: return createFunctionalObjectProperty();
      case SparqlmsPackage.INVERSE_FUNCTIONAL_OBJECT_PROPERTY: return createInverseFunctionalObjectProperty();
      case SparqlmsPackage.REFLEXIVE_OBJECT_PROPERTY: return createReflexiveObjectProperty();
      case SparqlmsPackage.IRREFLEXIVE_OBJECT_PROPERTY: return createIrreflexiveObjectProperty();
      case SparqlmsPackage.SYMMETRIC_OBJECT_PROPERTY: return createSymmetricObjectProperty();
      case SparqlmsPackage.ASYMMETRIC_OBJECT_PROPERTY: return createAsymmetricObjectProperty();
      case SparqlmsPackage.TRANSITIVE_OBJECT_PROPERTY: return createTransitiveObjectProperty();
      case SparqlmsPackage.INVERSE_OBJECT_PROPERTY: return createInverseObjectProperty();
      case SparqlmsPackage.SUB_DATA_PROPERTY_OF: return createSubDataPropertyOf();
      case SparqlmsPackage.EQUIVALENT_DATA_PROPERTIES: return createEquivalentDataProperties();
      case SparqlmsPackage.DISJOINT_DATA_PROPERTIES: return createDisjointDataProperties();
      case SparqlmsPackage.DATA_PROPERTY_DOMAIN: return createDataPropertyDomain();
      case SparqlmsPackage.DATA_PROPERTY_RANGE: return createDataPropertyRange();
      case SparqlmsPackage.FUNCTIONAL_DATA_PROPERTY: return createFunctionalDataProperty();
      case SparqlmsPackage.HAS_KEY: return createHasKey();
      case SparqlmsPackage.CLASS_DECLARATION: return createClassDeclaration();
      case SparqlmsPackage.OBJECT_PROPERTY_DECLARATION: return createObjectPropertyDeclaration();
      case SparqlmsPackage.DATATYPE_PROPERTY_DECLARATION: return createDatatypePropertyDeclaration();
      case SparqlmsPackage.INDIVIDUAL_DECLARATION: return createIndividualDeclaration();
      case SparqlmsPackage.TEMPLATE_PARAMETER: return createTemplateParameter();
      case SparqlmsPackage.TEMPLATE_SIGNATURE: return createTemplateSignature();
      case SparqlmsPackage.TEMPLATE_PARAMETER_SUBSTITUTION: return createTemplateParameterSubstitution();
      case SparqlmsPackage.TEMPLATE_BINDING: return createTemplateBinding();
      case SparqlmsPackage.DIRECT_CLASS_ASSERTION: return createDirectClassAssertion();
      case SparqlmsPackage.DIRECT_SUB_CLASS_OF: return createDirectSubClassOf();
      case SparqlmsPackage.STRICT_SUB_CLASS_OF: return createStrictSubClassOf();
      default:
   ...
   * @generated
   */
  public SparqlmsPackage getSparqlmsPackage()
  {
    return (SparqlmsPackage)getEPackage();
  }
   ...
   */
  @Deprecated
  public static SparqlmsPackage getPackage()
  {
    return SparqlmsPackage.eINSTANCE;
  }
