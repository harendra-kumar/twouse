 ...
 * <ul>
 *   <li>{@link west.twouse.language.sparqlas.impl.DataIntersectionOfImpl#getDataRanges <em>Data Ranges</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataIntersectionOfImpl extends DataRangeImpl implements DataIntersectionOf
{
  ...
  {
    return SparqlasPackage.Literals.DATA_INTERSECTION_OF;
  }
  ...
  public EList<DataRange> getDataRanges()
  {
    if (dataRanges == null)
    {
      dataRanges = new EObjectContainmentEList<DataRange>(DataRange.class, this, SparqlasPackage.DATA_INTERSECTION_OF__DATA_RANGES);
    }
    return dataRanges;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SparqlasPackage.DATA_INTERSECTION_OF__DATA_RANGES:
