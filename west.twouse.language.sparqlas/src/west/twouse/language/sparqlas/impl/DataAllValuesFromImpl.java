 ...
 * <ul>
 *   <li>{@link west.twouse.language.sparqlas.impl.DataAllValuesFromImpl#getDataRange <em>Data Range</em>}</li>
 *   <li>{@link west.twouse.language.sparqlas.impl.DataAllValuesFromImpl#getDataPropertyExpressions <em>Data Property Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataAllValuesFromImpl extends ClassExpressionImpl implements DataAllValuesFrom
{
  ...
  {
    return SparqlasPackage.Literals.DATA_ALL_VALUES_FROM;
  }
  ...
  public NotificationChain basicSetDataRange(DataRange newDataRange, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SparqlasPackage.DATA_ALL_VALUES_FROM__DATA_RANGE, oldDataRange, newDataRange);
  ...
  public void setDataRange(DataRange newDataRange)
  {
    if (newDataRange != dataRange)
    {
      ...
      if (dataRange != null)
        msgs = ((InternalEObject)dataRange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SparqlasPackage.DATA_ALL_VALUES_FROM__DATA_RANGE, null, msgs);
      if (newDataRange != null)
        msgs = ((InternalEObject)newDataRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SparqlasPackage.DATA_ALL_VALUES_FROM__DATA_RANGE, null, msgs);
      msgs = basicSetDataRange(newDataRange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparqlasPackage.DATA_ALL_VALUES_FROM__DATA_RANGE, newDataRange, newDataRange));
  }
  ...
  public EList<DataPropertyExpression> getDataPropertyExpressions()
  {
    ...
    {
      dataPropertyExpressions = new EObjectContainmentEList<DataPropertyExpression>(DataPropertyExpression.class, this, SparqlasPackage.DATA_ALL_VALUES_FROM__DATA_PROPERTY_EXPRESSIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SparqlasPackage.DATA_ALL_VALUES_FROM__DATA_RANGE:
        return basicSetDataRange(null, msgs);
      case SparqlasPackage.DATA_ALL_VALUES_FROM__DATA_PROPERTY_EXPRESSIONS:
