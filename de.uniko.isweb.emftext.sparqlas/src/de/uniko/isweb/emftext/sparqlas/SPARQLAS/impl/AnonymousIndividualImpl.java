 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.impl.AnonymousIndividualImpl#getNodeID <em>Node ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnonymousIndividualImpl extends IndividualImpl implements AnonymousIndividual {
   ...
   */
    ...
    return SPARQLASPackage.Literals.ANONYMOUS_INDIVIDUAL;
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPARQLASPackage.ANONYMOUS_INDIVIDUAL__NODE_ID, oldNodeID, nodeID));
  }
   ...
   */
    ...
    switch (featureID)
    {
      case SPARQLASPackage.ANONYMOUS_INDIVIDUAL__NODE_ID:
        return getNodeID();
    }
