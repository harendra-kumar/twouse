 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.impl.DataPropertyImpl#getConstantIRI <em>Constant IRI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataPropertyImpl extends DataPropertyExpressionImpl implements DataProperty {
   ...
   */
    ...
    return SPARQLASPackage.Literals.DATA_PROPERTY;
  }
   ...
   */
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SPARQLASPackage.DATA_PROPERTY__CONSTANT_IRI, oldConstantIRI, newConstantIRI);
   ...
   */
    ...
    if (newConstantIRI != constantIRI)
    {
      ...
      if (constantIRI != null)
        msgs = ((InternalEObject)constantIRI).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SPARQLASPackage.DATA_PROPERTY__CONSTANT_IRI, null, msgs);
      if (newConstantIRI != null)
        msgs = ((InternalEObject)newConstantIRI).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SPARQLASPackage.DATA_PROPERTY__CONSTANT_IRI, null, msgs);
      msgs = basicSetConstantIRI(newConstantIRI, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPARQLASPackage.DATA_PROPERTY__CONSTANT_IRI, newConstantIRI, newConstantIRI));
  }
   ...
   */
    ...
    switch (featureID)
    {
      case SPARQLASPackage.DATA_PROPERTY__CONSTANT_IRI:
   ...
   */
    ...
    if (baseClass == Constant.class)
    {
      switch (derivedFeatureID)
      {
        case SPARQLASPackage.DATA_PROPERTY__CONSTANT_IRI: return SPARQLASPackage.CONSTANT__CONSTANT_IRI;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == Constant.class)
    {
      switch (baseFeatureID)
      {
        case SPARQLASPackage.CONSTANT__CONSTANT_IRI: return SPARQLASPackage.DATA_PROPERTY__CONSTANT_IRI;
        default: return -1;
      }
    }
