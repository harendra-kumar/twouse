...
/**
 * A text editor for 'owl2fs' models.
 */
public class Owl2fsEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsCodeFoldingManager codeFoldingManager;
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBackgroundParsingStrategy bgParsingStrategy = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBackgroundParsingStrategy();
	private java.util.Collection<west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener>();
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsColorManager colorManager = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsColorManager();
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsOutlinePage outlinePage;
	...
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPropertySheetPage propertySheetPage;
	...
	private west.twouse.language.owl2fs.resource.owl2fs.ui.IOwl2fsBracketHandler bracketHandler;
	
	public Owl2fsEditor() {
		super();
		setDocumentProvider(new org.eclipse.ui.editors.text.FileDocumentProvider());
		setSourceViewerConfiguration(new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), Owl2fsEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource currentResource = getResource();
				...
				west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("west.twouse.language.owl2fs.resource.owl2fs.EditorContext");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsNature.activate(inputFile.getProject());
		...
		west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource loadedResource = (west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource) {
					setResource((west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the Owl2fsEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource textResource = (west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource) element.eResource();
			west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextToken token = lexer.getNextToken();
			...
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsMarkerHelper.unmark(resourceToRefresh);
						west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
	...
	public west.twouse.language.owl2fs.resource.owl2fs.ui.IOwl2fsBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(west.twouse.language.owl2fs.resource.owl2fs.ui.IOwl2fsBracketHandler bracketHandler) {
