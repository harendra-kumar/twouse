...
public class Owl2fsCompletionProcessor implements org.eclipse.jface.text.contentassist.IContentAssistProcessor {
	...
	public org.eclipse.jface.text.contentassist.ICompletionProposal[] computeCompletionProposals(org.eclipse.jface.text.ITextViewer viewer, int offset) {
		...
		west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsCodeCompletionHelper helper = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsCodeCompletionHelper();
		west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsCompletionProposal[] proposals = helper.computeCompletionProposals(textResource, content, offset);
		...
		int i = 0;
		for (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsCompletionProposal proposal : proposals) {
			...
			west.twouse.language.owl2fs.resource.owl2fs.ui.IOwl2fsBracketHandler bracketHandler = editor.getBracketHandler();
