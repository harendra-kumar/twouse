 ...
 * contains
 * <code>west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextDiagnostic</code>s
 * it uses the more precise information of this extended diagnostic type.
 */
public class Owl2fsMarkerHelper {
	
	public static final String MARKER_TYPE = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.PLUGIN_ID + ".problem";
