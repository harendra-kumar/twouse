...
public class Owl2fsBracketSet {
	...
	private java.util.ArrayList<de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair> bracketPairs;
	...
	private class BracketPair implements de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public Owl2fsBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
		...
		this.bracketPairs = new java.util.ArrayList<de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair>();
	...
	public de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair getBracketPair(String opening, String closing) {
		for (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair bracketPair : bracketPairs) {
	...
	public de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair getBracketPair(int index) {
		try {
	...
	public boolean setClosingEnabledInside(de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair remove(String opening, String closing) {
		for (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
