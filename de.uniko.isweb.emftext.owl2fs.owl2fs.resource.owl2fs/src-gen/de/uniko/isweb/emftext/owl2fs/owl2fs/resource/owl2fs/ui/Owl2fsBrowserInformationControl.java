...
// @since 3.2
///
public class Owl2fsBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput fInput;
	...
	public Owl2fsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public Owl2fsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public Owl2fsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput);
		...
		fInput= (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) input;
		...
		de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput getInput() {
		return fInput;
	}
