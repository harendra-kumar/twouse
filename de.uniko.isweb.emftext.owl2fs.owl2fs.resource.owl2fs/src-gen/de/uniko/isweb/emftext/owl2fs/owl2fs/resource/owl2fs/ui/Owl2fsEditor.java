...
public class Owl2fsEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsCodeFoldingManager codeFoldingManager;
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBackgroundParsingStrategy bgParsingStrategy = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBackgroundParsingStrategy();
	private java.util.Collection<de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener>();
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsColorManager colorManager = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsColorManager();
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsOutlinePage outlinePage;
	...
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsPropertySheetPage propertySheetPage;
	...
	public Owl2fsEditor() {
		...
		setSourceViewerConfiguration(new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource currentResource = getResource();
				...
				de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource loadedResource = (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource) {
					setResource((de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the Owl2fsEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource textResource = (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource) element.eResource();
			...
			de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextToken token = lexer.getNextToken();
			...
			de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsMarkerHelper.unmark(resourceToRefresh);
						de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
