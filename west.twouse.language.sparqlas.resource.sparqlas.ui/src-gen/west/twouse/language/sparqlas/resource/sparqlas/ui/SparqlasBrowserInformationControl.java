...
public class SparqlasBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasDocBrowserInformationControlInput);
		...
		fInput= (west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasDocBrowserInformationControlInput) input;
		...
		west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasDocBrowserInformationControlInput getInput() {
		return fInput;
	}
