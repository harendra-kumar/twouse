 ...
 */
public class SparqlasUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "west.twouse.language.sparqlas.resource.sparqlas.ui";
	...
	private static SparqlasUIPlugin plugin;
	
	public SparqlasUIPlugin() {
		super();
	}
	...
	public static SparqlasUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SparqlasUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SparqlasUIPlugin.PLUGIN_ID, message);
		}
		final SparqlasUIPlugin pluginInstance = SparqlasUIPlugin.getDefault();
