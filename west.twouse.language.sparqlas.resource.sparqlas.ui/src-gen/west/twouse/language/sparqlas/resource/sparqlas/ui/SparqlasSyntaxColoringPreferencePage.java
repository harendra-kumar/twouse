...
public class SparqlasSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasPixelConverter pixelConverter = new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasPixelConverter(composite);
	...
	public SparqlasSyntaxColoringPreferencePage() {
		...
		west.twouse.language.sparqlas.resource.sparqlas.ISparqlasMetaInformation syntaxPlugin = new west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor) {
			west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor emfTextEditor = (west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor) editor;
