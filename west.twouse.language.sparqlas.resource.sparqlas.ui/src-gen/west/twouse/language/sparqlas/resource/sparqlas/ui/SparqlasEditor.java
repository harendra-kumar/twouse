...
public class SparqlasEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasCodeFoldingManager codeFoldingManager;
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasBackgroundParsingStrategy bgParsingStrategy = new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasBackgroundParsingStrategy();
	private java.util.Collection<west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBackgroundParsingListener>();
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasColorManager colorManager = new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasColorManager();
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasOutlinePage outlinePage;
	...
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasPropertySheetPage propertySheetPage;
	...
	private west.twouse.language.sparqlas.resource.sparqlas.ui.ISparqlasBracketHandler bracketHandler;
	
	public SparqlasEditor() {
		super();
		setDocumentProvider(new org.eclipse.ui.editors.text.FileDocumentProvider());
		setSourceViewerConfiguration(new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBackgroundParsingListener {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource currentResource = getResource();
				...
				west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("west.twouse.language.sparqlas.resource.sparqlas.EditorContext");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasNature.activate(inputFile.getProject());
		...
		west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource loadedResource = (west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource) {
					setResource((west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SparqlasEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource textResource = (west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource) element.eResource();
			...
			west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextToken token = lexer.getNextToken();
			...
			west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasUIPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasMarkerHelper.unmark(resourceToRefresh);
						west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasUIPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
	...
	public west.twouse.language.sparqlas.resource.sparqlas.ui.ISparqlasBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(west.twouse.language.sparqlas.resource.sparqlas.ui.ISparqlasBracketHandler bracketHandler) {
