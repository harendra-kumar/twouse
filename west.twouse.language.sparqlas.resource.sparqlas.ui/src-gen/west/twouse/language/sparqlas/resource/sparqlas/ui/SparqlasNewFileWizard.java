...
public class SparqlasNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasNewFileWizardPage page;
	...
	public void addPages() {
		page = new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasUIPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasUIPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasMetaInformation().getSyntaxName();
	}
