...
public class SparqlasNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "west.twouse.language.sparqlas.resource.sparqlas.nature";
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
