...
public class SparqlasCodeFoldingManager {
	...
	private class FoldingUpdateListener implements west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor) {
				west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor editor = (west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor) workbenchPart;
	...
	protected west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor editor;
	...
	public SparqlasCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor textEditor) {
	...
	private void addCloseListener(final west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor editor) {
	...
	private java.io.File getCodeFoldingStateFile(String uriString) {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.PLUGIN_ID);
	...
	private String makeMD5(String text) {
		...
		try {
			...
			west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource textResource = (west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
