...
public class SparqlasHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public SparqlasHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor) {
					west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor emftEditor = (west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor) editorPart;
