...
public class SparqlasNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	public boolean performFinish() {
		...
		try {
			...
			west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
