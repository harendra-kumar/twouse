 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.DataComplementOf#getDataRange <em>Data Range</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataComplementOf()
 * @model
 * @generated
 */
public interface DataComplementOf extends DataRange, Expression
{
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataComplementOf_DataRange()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.DataComplementOf#getDataRange <em>Data Range</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
