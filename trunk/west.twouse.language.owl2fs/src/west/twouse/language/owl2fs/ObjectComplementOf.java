 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.ObjectComplementOf#getClassExpression <em>Class Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getObjectComplementOf()
 * @model
 * @generated
 */
public interface ObjectComplementOf extends ClassExpression, Expression
{
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getObjectComplementOf_ClassExpression()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.ObjectComplementOf#getClassExpression <em>Class Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
