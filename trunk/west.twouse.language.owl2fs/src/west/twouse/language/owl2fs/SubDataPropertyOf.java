 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.SubDataPropertyOf#getSuperDataPropertyExpression <em>Super Data Property Expression</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.SubDataPropertyOf#getSubDataPropertyExpression <em>Sub Data Property Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getSubDataPropertyOf()
 * @model
 * @generated
 */
public interface SubDataPropertyOf extends DataPropertyAxiom
{
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getSubDataPropertyOf_SuperDataPropertyExpression()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.SubDataPropertyOf#getSuperDataPropertyExpression <em>Super Data Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getSubDataPropertyOf_SubDataPropertyExpression()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.SubDataPropertyOf#getSubDataPropertyExpression <em>Sub Data Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
