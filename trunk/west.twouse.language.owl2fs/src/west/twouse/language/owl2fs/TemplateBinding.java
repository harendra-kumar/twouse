 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.TemplateBinding#getParameterSubstitution <em>Parameter Substitution</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.TemplateBinding#getBoundElement <em>Bound Element</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.TemplateBinding#getSignature <em>Signature</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getTemplateBinding()
 * @model
 * @generated
 */
public interface TemplateBinding extends EObject
{
   ...
   * It is bidirectional and its opposite is '{@link west.twouse.language.owl2fs.TemplateParameterSubstitution#getTemplateBinding <em>Template Binding</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getTemplateBinding_ParameterSubstitution()
   ...
   * It is bidirectional and its opposite is '{@link west.twouse.language.owl2fs.TemplateableElement#getTemplateBinding <em>Template Binding</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getTemplateBinding_BoundElement()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.TemplateBinding#getBoundElement <em>Bound Element</em>}' container reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getTemplateBinding_Signature()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.TemplateBinding#getSignature <em>Signature</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
