 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.ObjectPropertyRange#getRange <em>Range</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.ObjectPropertyRange#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getObjectPropertyRange()
 * @model
 * @generated
 */
public interface ObjectPropertyRange extends ObjectPropertyAxiom
{
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getObjectPropertyRange_Range()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.ObjectPropertyRange#getRange <em>Range</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getObjectPropertyRange_ObjectPropertyExpression()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.ObjectPropertyRange#getObjectPropertyExpression <em>Object Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
