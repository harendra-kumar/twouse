 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.impl.EntityImpl#getEntityIRI <em>Entity IRI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EntityImpl extends EObjectImpl implements Entity
{
  ...
  public NotificationChain basicSetEntityIRI(IRI newEntityIRI, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Owl2fsPackage.ENTITY__ENTITY_IRI, oldEntityIRI, newEntityIRI);
  ...
  public void setEntityIRI(IRI newEntityIRI)
  {
    if (newEntityIRI != entityIRI)
    {
      ...
      if (entityIRI != null)
        msgs = ((InternalEObject)entityIRI).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.ENTITY__ENTITY_IRI, null, msgs);
      if (newEntityIRI != null)
        msgs = ((InternalEObject)newEntityIRI).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.ENTITY__ENTITY_IRI, null, msgs);
      msgs = basicSetEntityIRI(newEntityIRI, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.ENTITY__ENTITY_IRI, newEntityIRI, newEntityIRI));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Owl2fsPackage.ENTITY__ENTITY_IRI:
