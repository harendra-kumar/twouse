 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.impl.DataSomeValuesFromImpl#getDataRange <em>Data Range</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.impl.DataSomeValuesFromImpl#getDataPropertyExpressions <em>Data Property Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataSomeValuesFromImpl extends ClassExpressionImpl implements DataSomeValuesFrom
{
  ...
  public EList<DataPropertyExpression> getDataPropertyExpressions()
  {
    ...
    {
      dataPropertyExpressions = new EObjectContainmentEList<DataPropertyExpression>(DataPropertyExpression.class, this, Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTY_EXPRESSIONS);
    }
