 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.impl.AnnotationPropertyRangeImpl#getAnnotationProperty <em>Annotation Property</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.impl.AnnotationPropertyRangeImpl#getIri <em>Iri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationPropertyRangeImpl extends AnnotationAxiomImpl implements AnnotationPropertyRange
{
  ...
  {
    return Owl2fsPackage.Literals.ANNOTATION_PROPERTY_RANGE;
  }
  ...
  public NotificationChain basicSetAnnotationProperty(AnnotationProperty newAnnotationProperty, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__ANNOTATION_PROPERTY, oldAnnotationProperty, newAnnotationProperty);
  ...
  public void setAnnotationProperty(AnnotationProperty newAnnotationProperty)
  {
    if (newAnnotationProperty != annotationProperty)
    {
      ...
      if (annotationProperty != null)
        msgs = ((InternalEObject)annotationProperty).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__ANNOTATION_PROPERTY, null, msgs);
      if (newAnnotationProperty != null)
        msgs = ((InternalEObject)newAnnotationProperty).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__ANNOTATION_PROPERTY, null, msgs);
      msgs = basicSetAnnotationProperty(newAnnotationProperty, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__ANNOTATION_PROPERTY, newAnnotationProperty, newAnnotationProperty));
  }
  ...
  public NotificationChain basicSetIri(IRI newIri, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__IRI, oldIri, newIri);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setIri(IRI newIri)
  {
    if (newIri != iri)
    {
      NotificationChain msgs = null;
      if (iri != null)
        msgs = ((InternalEObject)iri).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__IRI, null, msgs);
      if (newIri != null)
        msgs = ((InternalEObject)newIri).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__IRI, null, msgs);
      msgs = basicSetIri(newIri, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__IRI, newIri, newIri));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__ANNOTATION_PROPERTY:
        return basicSetAnnotationProperty(null, msgs);
      case Owl2fsPackage.ANNOTATION_PROPERTY_RANGE__IRI:
