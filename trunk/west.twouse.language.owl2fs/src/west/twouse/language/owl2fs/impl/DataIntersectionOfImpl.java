 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.impl.DataIntersectionOfImpl#getDataRange <em>Data Range</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataIntersectionOfImpl extends DataRangeImpl implements DataIntersectionOf
{
  ...
  {
    return Owl2fsPackage.Literals.DATA_INTERSECTION_OF;
  }
  ...
  public EList<DataRange> getDataRange()
  {
    if (dataRange == null)
    {
      dataRange = new EObjectContainmentEList<DataRange>(DataRange.class, this, Owl2fsPackage.DATA_INTERSECTION_OF__DATA_RANGE);
    }
    return dataRange;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Owl2fsPackage.DATA_INTERSECTION_OF__DATA_RANGE:
