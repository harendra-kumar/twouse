 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.impl.TemplateParameterSubstitutionImpl#getActual <em>Actual</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.impl.TemplateParameterSubstitutionImpl#getFormal <em>Formal</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.impl.TemplateParameterSubstitutionImpl#getTemplateBinding <em>Template Binding</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateParameterSubstitutionImpl extends EObjectImpl implements TemplateParameterSubstitution
{
   ...
   * @generated
   */
  public NotificationChain basicSetFormal(TemplateParameter newFormal, NotificationChain msgs)
  {
    TemplateParameter oldFormal = formal;
    formal = newFormal;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Owl2fsPackage.TEMPLATE_PARAMETER_SUBSTITUTION__FORMAL, oldFormal, newFormal);
  ...
  public void setFormal(TemplateParameter newFormal)
  {
    if (newFormal != formal)
    {
      ...
      if (formal != null)
        msgs = ((InternalEObject)formal).eInverseRemove(this, Owl2fsPackage.TEMPLATE_PARAMETER__PARAMETER_SUBSTITUTION, TemplateParameter.class, msgs);
      if (newFormal != null)
        msgs = ((InternalEObject)newFormal).eInverseAdd(this, Owl2fsPackage.TEMPLATE_PARAMETER__PARAMETER_SUBSTITUTION, TemplateParameter.class, msgs);
      msgs = basicSetFormal(newFormal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.TEMPLATE_PARAMETER_SUBSTITUTION__FORMAL, newFormal, newFormal));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Owl2fsPackage.TEMPLATE_PARAMETER_SUBSTITUTION__FORMAL:
        if (formal != null)
          msgs = ((InternalEObject)formal).eInverseRemove(this, Owl2fsPackage.TEMPLATE_PARAMETER__PARAMETER_SUBSTITUTION, TemplateParameter.class, msgs);
        return basicSetFormal((TemplateParameter)otherEnd, msgs);
