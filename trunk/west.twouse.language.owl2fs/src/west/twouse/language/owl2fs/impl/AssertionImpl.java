 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.impl.AssertionImpl#getAxiomAnnotations <em>Axiom Annotations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AssertionImpl extends AxiomImpl implements Assertion
{
  ...
  {
    return Owl2fsPackage.Literals.ASSERTION;
  }
  ...
  public EList<Annotation> getAxiomAnnotations()
  {
    ...
    {
      axiomAnnotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, Owl2fsPackage.ASSERTION__AXIOM_ANNOTATIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Owl2fsPackage.ASSERTION__AXIOM_ANNOTATIONS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == AnnotationAxiom.class)
    {
      ...
      {
        case Owl2fsPackage.ASSERTION__AXIOM_ANNOTATIONS: return Owl2fsPackage.ANNOTATION_AXIOM__AXIOM_ANNOTATIONS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == AnnotationAxiom.class)
    {
      ...
      {
        case Owl2fsPackage.ANNOTATION_AXIOM__AXIOM_ANNOTATIONS: return Owl2fsPackage.ASSERTION__AXIOM_ANNOTATIONS;
        default: return -1;
      }
    }
