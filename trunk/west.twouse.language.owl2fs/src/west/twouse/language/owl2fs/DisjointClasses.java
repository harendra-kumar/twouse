 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.DisjointClasses#getDisjointClassExpressions <em>Disjoint Class Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getDisjointClasses()
 * @model
 * @generated
 */
public interface DisjointClasses extends ClassAxiom
{
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getDisjointClasses_DisjointClassExpressions()
