 ...
 */
public class YumlExpectedTerminal {
	
	private int followSetID;
	private west.twouse.language.yuml.resource.yuml.IYumlExpectedElement terminal;
	...
	public YumlExpectedTerminal(west.twouse.language.yuml.resource.yuml.IYumlExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public west.twouse.language.yuml.resource.yuml.IYumlExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((YumlExpectedTerminal) o).terminal);
	}
