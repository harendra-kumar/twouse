 ...
 * plug-in.
 */
public interface IYumlMetaInformation {
	 ...
	 */
	public west.twouse.language.yuml.resource.yuml.IYumlTextPrinter createPrinter(java.io.OutputStream ouputStream, west.twouse.language.yuml.resource.yuml.IYumlTextResource resource);
