...
public class YumlNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "west.twouse.language.yuml.resource.yuml.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {west.twouse.language.yuml.resource.yuml.mopp.YumlBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(west.twouse.language.yuml.resource.yuml.mopp.YumlBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
