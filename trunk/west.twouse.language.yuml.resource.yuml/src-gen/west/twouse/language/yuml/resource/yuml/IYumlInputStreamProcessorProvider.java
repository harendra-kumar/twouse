 ...
 * conversion.
 */
public interface IYumlInputStreamProcessorProvider {
	 ...
	 */
	public west.twouse.language.yuml.resource.yuml.mopp.YumlInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}
