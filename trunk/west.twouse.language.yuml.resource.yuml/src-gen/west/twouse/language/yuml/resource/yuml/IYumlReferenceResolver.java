 ...
 * resolver
 */
public interface IYumlReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends west.twouse.language.yuml.resource.yuml.IYumlConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, west.twouse.language.yuml.resource.yuml.IYumlReferenceResolveResult<ReferenceType> result);
