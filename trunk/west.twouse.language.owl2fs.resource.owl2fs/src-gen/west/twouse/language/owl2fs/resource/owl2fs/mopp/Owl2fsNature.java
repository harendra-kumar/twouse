...
public class Owl2fsNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "west.twouse.language.owl2fs.resource.owl2fs.nature";
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
