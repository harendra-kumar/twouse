...
public interface IOwl2fsMetaInformation {
	 ...
	 */
	public west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextParser createParser(java.io.InputStream inputStream, String encoding);
	 ...
	 */
	public west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextPrinter createPrinter(java.io.OutputStream ouputStream, west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource resource);
	 ...
	 */
	public west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTokenStyle getDefaultTokenStyle(String tokenName);
