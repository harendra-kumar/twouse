...
public class Owl2fsBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput);
		...
		fInput= (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) input;
		...
		west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput getInput() {
		return fInput;
	}
