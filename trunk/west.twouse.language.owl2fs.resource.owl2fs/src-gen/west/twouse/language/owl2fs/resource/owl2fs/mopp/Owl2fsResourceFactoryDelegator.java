...
public class Owl2fsResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	protected void init() {
		...
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
		...
		if (factories.get("") == null) {
			factories.put("", new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsResourceFactory());
		}
	}
