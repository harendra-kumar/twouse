...
public class Owl2fsHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionHelper positionHelper = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsTokenScanner scanner;
	...
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsOccurrence occurrence;
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener {
	...
	public Owl2fsHighlighting(west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsColorManager colorManager, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsTokenScanner(colorManager);
		occurrence = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBracketSet(sourceviewer, "owl2fs");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.PROXY.toString());
			lastStyleRange = null;
		}
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.DEFINTION.toString()) || category.equals(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.PROXY.toString())) && lastStyleRange != null;
		if (category.equals(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource) {
