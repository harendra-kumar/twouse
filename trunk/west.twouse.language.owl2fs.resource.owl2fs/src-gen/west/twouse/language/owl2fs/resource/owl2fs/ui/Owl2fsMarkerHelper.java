...
// If a resource contains <code>west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextDiagnostic</code>s it uses the more precise information of
// this extended diagnostic type.
public class Owl2fsMarkerHelper {
	
	public static final String MARKER_TYPE = west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.PLUGIN_ID + ".problem";
	...
	private static void createMarkersFromDiagnostics(org.eclipse.emf.ecore.resource.Resource resource, org.eclipse.core.resources.IFile file, java.util.List<org.eclipse.emf.ecore.resource.Resource.Diagnostic> diagnostics, int markerSeverity) throws org.eclipse.core.runtime.CoreException {
		...
		for (org.eclipse.emf.ecore.resource.Resource.Diagnostic diagnostic : diagnostics) {
			try {
				...
				if (diagnostic instanceof west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextDiagnostic) {
					west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextDiagnostic textDiagnostic = (west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextDiagnostic) diagnostic;
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) throws org.eclipse.core.runtime.CoreException {
		org.eclipse.core.resources.IFile file = (org.eclipse.core.resources.IFile) org.eclipse.core.resources.ResourcesPlugin.getWorkspace().getRoot().findMember(resource.getURI().toPlatformString(true));
		if (file != null) {
			file.deleteMarkers(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsMarkerHelper.MARKER_TYPE, false, org.eclipse.core.resources.IResource.DEPTH_ZERO);
		}
	}
}
