...
// hovers, is a proxy.
public class Owl2fsHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	...
	public Owl2fsHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
