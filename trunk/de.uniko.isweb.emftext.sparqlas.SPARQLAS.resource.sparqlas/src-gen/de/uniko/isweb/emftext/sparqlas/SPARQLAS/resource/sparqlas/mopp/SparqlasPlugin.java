...
public class SparqlasPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas";
	...
	private static SparqlasPlugin plugin;
	
	public SparqlasPlugin() {
		super();
	}
	...
	public static SparqlasPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SparqlasPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SparqlasPlugin.PLUGIN_ID, message);
		}
		final SparqlasPlugin pluginInstance = SparqlasPlugin.getDefault();
