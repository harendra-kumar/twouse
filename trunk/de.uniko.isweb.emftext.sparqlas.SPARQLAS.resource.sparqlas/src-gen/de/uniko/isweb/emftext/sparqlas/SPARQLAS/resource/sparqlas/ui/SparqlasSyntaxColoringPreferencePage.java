...
///
public class SparqlasSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasPixelConverter pixelConverter = new de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasPixelConverter(composite);
	...
	public SparqlasSyntaxColoringPreferencePage() {
		super();
		
		de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ISparqlasMetaInformation syntaxPlugin = new de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.mopp.SparqlasMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasEditor) {
			de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasEditor emfTextEditor = (de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasEditor) editor;
