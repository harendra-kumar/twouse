 ...
 */
public class YumlBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final west.twouse.language.yuml.resource.yuml.IYumlTextResource resource, final west.twouse.language.yuml.resource.yuml.ui.YumlEditor editor) {
		if (resource == null) {
			return;
		}
