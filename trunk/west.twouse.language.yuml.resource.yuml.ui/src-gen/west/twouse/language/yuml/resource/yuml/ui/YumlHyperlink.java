 ...
 */
public class YumlHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public YumlHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof west.twouse.language.yuml.resource.yuml.ui.YumlEditor) {
					west.twouse.language.yuml.resource.yuml.ui.YumlEditor emftEditor = (west.twouse.language.yuml.resource.yuml.ui.YumlEditor) editorPart;
