 ...
 */
public class YumlCodeFoldingManager {
	
	private class FoldingUpdateListener implements west.twouse.language.yuml.resource.yuml.IYumlBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(west.twouse.language.yuml.resource.yuml.ui.YumlEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof west.twouse.language.yuml.resource.yuml.ui.YumlEditor) {
				west.twouse.language.yuml.resource.yuml.ui.YumlEditor editor = (west.twouse.language.yuml.resource.yuml.ui.YumlEditor) workbenchPart;
	...
	protected west.twouse.language.yuml.resource.yuml.ui.YumlEditor editor;
	 ...
	 */
	public YumlCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,west.twouse.language.yuml.resource.yuml.ui.YumlEditor textEditor) {
	...
	private void addCloseListener(final west.twouse.language.yuml.resource.yuml.ui.YumlEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			west.twouse.language.yuml.resource.yuml.ui.YumlUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		west.twouse.language.yuml.resource.yuml.IYumlTextResource textResource = (west.twouse.language.yuml.resource.yuml.IYumlTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
