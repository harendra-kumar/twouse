 ...
 */
public class YumlPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(west.twouse.language.yuml.resource.yuml.ui.YumlUIPlugin.getDefault().getPreferenceStore());
		setDescription(" Yuml Text Editor Preferences");
	}
