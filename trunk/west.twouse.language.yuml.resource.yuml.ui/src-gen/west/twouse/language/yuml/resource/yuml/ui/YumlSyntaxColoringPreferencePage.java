 ...
 */
public class YumlSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.yuml.resource.yuml.ui.YumlSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		west.twouse.language.yuml.resource.yuml.ui.YumlPixelConverter pixelConverter = new west.twouse.language.yuml.resource.yuml.ui.YumlPixelConverter(composite);
	...
	public YumlSyntaxColoringPreferencePage() {
		super();
		
		west.twouse.language.yuml.resource.yuml.IYumlMetaInformation syntaxPlugin = new west.twouse.language.yuml.resource.yuml.mopp.YumlMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof west.twouse.language.yuml.resource.yuml.ui.YumlEditor) {
			west.twouse.language.yuml.resource.yuml.ui.YumlEditor emfTextEditor = (west.twouse.language.yuml.resource.yuml.ui.YumlEditor) editor;
