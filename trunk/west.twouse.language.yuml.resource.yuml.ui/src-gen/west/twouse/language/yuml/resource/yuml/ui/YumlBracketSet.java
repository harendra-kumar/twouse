...
public class YumlBracketSet {
	...
	private java.util.ArrayList<west.twouse.language.yuml.resource.yuml.IYumlBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements west.twouse.language.yuml.resource.yuml.IYumlBracketPair {
	 ...
	 */
	private class ClosingListener implements west.twouse.language.yuml.resource.yuml.ui.IYumlBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				west.twouse.language.yuml.resource.yuml.IYumlBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public YumlBracketSet(west.twouse.language.yuml.resource.yuml.ui.YumlEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new west.twouse.language.yuml.resource.yuml.mopp.YumlMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<west.twouse.language.yuml.resource.yuml.IYumlBracketPair>();
	 ...
	 */
	public west.twouse.language.yuml.resource.yuml.IYumlBracketPair getBracketPair(String opening, String closing) {
		for (west.twouse.language.yuml.resource.yuml.IYumlBracketPair bracketPair : bracketPairs) {
	...
	public west.twouse.language.yuml.resource.yuml.IYumlBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(west.twouse.language.yuml.resource.yuml.IYumlBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + west.twouse.language.yuml.resource.yuml.ui.YumlPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public west.twouse.language.yuml.resource.yuml.IYumlBracketPair remove(String opening, String closing) {
		for (west.twouse.language.yuml.resource.yuml.IYumlBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<west.twouse.language.yuml.resource.yuml.IYumlBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, west.twouse.language.yuml.resource.yuml.ui.YumlPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, west.twouse.language.yuml.resource.yuml.ui.YumlPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
