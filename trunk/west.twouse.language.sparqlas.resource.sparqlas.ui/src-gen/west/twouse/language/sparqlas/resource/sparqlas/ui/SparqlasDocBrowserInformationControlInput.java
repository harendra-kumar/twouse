 ...
 * olInput</code>.
 */
public class SparqlasDocBrowserInformationControlInput {
	
	private final SparqlasDocBrowserInformationControlInput fPrevious;
	private SparqlasDocBrowserInformationControlInput fNext;
	 ...
	 */
	public SparqlasDocBrowserInformationControlInput(SparqlasDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public SparqlasDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public SparqlasDocBrowserInformationControlInput getNext() {
		return fNext;
	}
