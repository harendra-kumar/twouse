 ...
 */
public class SparqlasBracketSet {
	...
	private java.util.ArrayList<west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair {
	 ...
	 */
	private class ClosingListener implements west.twouse.language.sparqlas.resource.sparqlas.ui.ISparqlasBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public SparqlasBracketSet(west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair>();
	 ...
	 */
	public west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair getBracketPair(String opening, String closing) {
		for (west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair bracketPair : bracketPairs) {
	...
	public west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair remove(String opening, String closing) {
		for (west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<west.twouse.language.sparqlas.resource.sparqlas.ISparqlasBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
