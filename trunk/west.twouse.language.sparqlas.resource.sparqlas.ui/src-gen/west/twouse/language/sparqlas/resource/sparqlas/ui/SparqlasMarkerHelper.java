 ...
 * contains
 * <code>west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextDiagnostic</c
 * ode>s it uses the more precise information of this extended diagnostic type.
 */
public class SparqlasMarkerHelper {
	
	public static final String MARKER_TYPE = west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasUIPlugin.PLUGIN_ID + ".problem";
