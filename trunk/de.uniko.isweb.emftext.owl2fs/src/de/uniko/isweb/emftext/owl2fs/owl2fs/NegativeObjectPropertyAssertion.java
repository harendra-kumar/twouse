 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.NegativeObjectPropertyAssertion#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.NegativeObjectPropertyAssertion#getSourceIndividual <em>Source Individual</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.NegativeObjectPropertyAssertion#getTargetIndividual <em>Target Individual</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getNegativeObjectPropertyAssertion()
 * @model
 * @generated
 */
public interface NegativeObjectPropertyAssertion extends Assertion
{
   ...
   * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getNegativeObjectPropertyAssertion_ObjectPropertyExpression()
  ...
  /**
   * Sets the value of the '{@link de.uniko.isweb.emftext.owl2fs.owl2fs.NegativeObjectPropertyAssertion#getObjectPropertyExpression <em>Object Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getNegativeObjectPropertyAssertion_SourceIndividual()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uniko.isweb.emftext.owl2fs.owl2fs.NegativeObjectPropertyAssertion#getSourceIndividual <em>Source Individual</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getNegativeObjectPropertyAssertion_TargetIndividual()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uniko.isweb.emftext.owl2fs.owl2fs.NegativeObjectPropertyAssertion#getTargetIndividual <em>Target Individual</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
