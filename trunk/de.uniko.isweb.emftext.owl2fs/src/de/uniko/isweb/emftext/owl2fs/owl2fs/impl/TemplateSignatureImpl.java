 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.TemplateSignatureImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.TemplateSignatureImpl#getOwnedParameter <em>Owned Parameter</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.TemplateSignatureImpl#getTemplate <em>Template</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateSignatureImpl extends EObjectImpl implements TemplateSignature
{
  ...
  public EList<TemplateParameter> getParameter()
  {
    if (parameter == null)
    {
      parameter = new EObjectResolvingEList<TemplateParameter>(TemplateParameter.class, this, Owl2fsPackage.TEMPLATE_SIGNATURE__PARAMETER);
    }
    return parameter;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Owl2fsPackage.TEMPLATE_SIGNATURE__PARAMETER:
        return getParameter();
      case Owl2fsPackage.TEMPLATE_SIGNATURE__OWNED_PARAMETER:
