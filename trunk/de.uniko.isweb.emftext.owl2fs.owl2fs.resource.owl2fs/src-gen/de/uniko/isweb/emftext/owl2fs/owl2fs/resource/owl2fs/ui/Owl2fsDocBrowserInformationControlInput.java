...
public class Owl2fsDocBrowserInformationControlInput {
	
	private final Owl2fsDocBrowserInformationControlInput fPrevious;
	private Owl2fsDocBrowserInformationControlInput fNext;
	...
	///
	public Owl2fsDocBrowserInformationControlInput(Owl2fsDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public Owl2fsDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public Owl2fsDocBrowserInformationControlInput getNext() {
		return fNext;
	}
