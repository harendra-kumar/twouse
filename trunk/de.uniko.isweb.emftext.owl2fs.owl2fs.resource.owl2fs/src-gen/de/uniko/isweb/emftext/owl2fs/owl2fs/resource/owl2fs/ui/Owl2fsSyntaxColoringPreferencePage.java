...
///
public class Owl2fsSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsPixelConverter pixelConverter = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsPixelConverter(composite);
	...
	public Owl2fsSyntaxColoringPreferencePage() {
		super();
		
		de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsMetaInformation syntaxPlugin = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.mopp.Owl2fsMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsEditor) {
			de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsEditor emfTextEditor = (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsEditor) editor;
