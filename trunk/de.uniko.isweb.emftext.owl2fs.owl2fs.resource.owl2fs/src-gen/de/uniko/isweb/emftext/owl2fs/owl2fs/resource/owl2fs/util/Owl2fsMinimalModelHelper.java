...
public class Owl2fsMinimalModelHelper {
	...
	private final static de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.util.Owl2fsEClassUtil eClassUtil = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.util.Owl2fsEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.util.Owl2fsStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.util.Owl2fsListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if(attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.util.Owl2fsStringUtil.capitalize(attribute.getName());
					}
					java.lang.Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.util.Owl2fsListUtil.castListUnchecked(value);
