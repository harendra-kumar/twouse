...
//
public class Owl2fsTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl infoControl) {
		...
		public void run() {
			de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput infoInput = (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHyperlink hyperlink = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl iControl = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) {
							de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput input = (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl.isAvailable(parent)) {
				de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl iControl = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public Owl2fsTextHover(de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.mopp.Owl2fsMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.IOwl2fsTextResource textResource = editor.getResource();
	...
	private de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.insertPageProlog(buffer, 0, de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsTextHover.getStyleSheet());
			de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.addPageEpilog(buffer);
			return new de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(de.uniko.isweb.emftext.owl2fs.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.PLUGIN_ID);
