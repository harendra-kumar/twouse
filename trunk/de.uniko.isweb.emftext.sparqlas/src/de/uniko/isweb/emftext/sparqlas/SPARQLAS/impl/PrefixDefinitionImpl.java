 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.impl.PrefixDefinitionImpl#getPref <em>Pref</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.impl.PrefixDefinitionImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrefixDefinitionImpl extends EObjectImpl implements PrefixDefinition {
   ...
   */
    ...
    return SPARQLASPackage.Literals.PREFIX_DEFINITION;
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPARQLASPackage.PREFIX_DEFINITION__PREF, oldPref, pref));
  }
   ...
   */
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SPARQLASPackage.PREFIX_DEFINITION__NAMESPACE, oldNamespace, newNamespace);
   ...
   */
    ...
    if (newNamespace != namespace)
    {
      ...
      if (namespace != null)
        msgs = ((InternalEObject)namespace).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SPARQLASPackage.PREFIX_DEFINITION__NAMESPACE, null, msgs);
      if (newNamespace != null)
        msgs = ((InternalEObject)newNamespace).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SPARQLASPackage.PREFIX_DEFINITION__NAMESPACE, null, msgs);
      msgs = basicSetNamespace(newNamespace, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPARQLASPackage.PREFIX_DEFINITION__NAMESPACE, newNamespace, newNamespace));
  }
   ...
   */
    ...
    switch (featureID)
    {
      case SPARQLASPackage.PREFIX_DEFINITION__NAMESPACE:
   ...
   */
    ...
    switch (featureID)
    {
      case SPARQLASPackage.PREFIX_DEFINITION__PREF:
        return getPref();
      case SPARQLASPackage.PREFIX_DEFINITION__NAMESPACE:
        return getNamespace();
    }
