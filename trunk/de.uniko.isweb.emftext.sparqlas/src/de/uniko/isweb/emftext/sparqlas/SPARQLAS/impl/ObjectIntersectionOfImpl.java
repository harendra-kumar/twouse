 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.impl.ObjectIntersectionOfImpl#getClassExpressions <em>Class Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectIntersectionOfImpl extends ClassExpressionImpl implements ObjectIntersectionOf {
   ...
   */
    ...
    return SPARQLASPackage.Literals.OBJECT_INTERSECTION_OF;
  }
   ...
   */
    ...
    {
      classExpressions = new EObjectContainmentEList<ClassExpression>(ClassExpression.class, this, SPARQLASPackage.OBJECT_INTERSECTION_OF__CLASS_EXPRESSIONS);
    }
   ...
   */
    ...
    switch (featureID)
    {
      case SPARQLASPackage.OBJECT_INTERSECTION_OF__CLASS_EXPRESSIONS:
