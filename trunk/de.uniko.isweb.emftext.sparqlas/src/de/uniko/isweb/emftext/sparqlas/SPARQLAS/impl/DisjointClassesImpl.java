 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.impl.DisjointClassesImpl#getClassExpressions <em>Class Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DisjointClassesImpl extends ClassAtomImpl implements DisjointClasses {
	/**
   ...
   */
    ...
    return SPARQLASPackage.Literals.DISJOINT_CLASSES;
  }
   ...
   */
    ...
    {
      classExpressions = new EObjectContainmentEList<ClassExpression>(ClassExpression.class, this, SPARQLASPackage.DISJOINT_CLASSES__CLASS_EXPRESSIONS);
    }
   ...
   */
    ...
    switch (featureID)
    {
      case SPARQLASPackage.DISJOINT_CLASSES__CLASS_EXPRESSIONS:
