 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.SubClassOf#getSubClassExpression <em>Sub Class Expression</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.SubClassOf#getSuperClassExpression <em>Super Class Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uniko.isweb.emftext.sparqlas.SPARQLAS.SPARQLASPackage#getSubClassOf()
 * @model
 * @generated
 */
public interface SubClassOf extends ClassAtom {
	/**
   ...
   * @see de.uniko.isweb.emftext.sparqlas.SPARQLAS.SPARQLASPackage#getSubClassOf_SubClassExpression()
   ...
   */
	...
	/**
   * Sets the value of the '{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.SubClassOf#getSubClassExpression <em>Sub Class Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see de.uniko.isweb.emftext.sparqlas.SPARQLAS.SPARQLASPackage#getSubClassOf_SuperClassExpression()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.SubClassOf#getSuperClassExpression <em>Super Class Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
