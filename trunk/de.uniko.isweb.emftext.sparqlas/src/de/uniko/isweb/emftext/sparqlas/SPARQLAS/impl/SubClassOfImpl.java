 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.impl.SubClassOfImpl#getSubClassExpression <em>Sub Class Expression</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.sparqlas.SPARQLAS.impl.SubClassOfImpl#getSuperClassExpression <em>Super Class Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubClassOfImpl extends ClassAtomImpl implements SubClassOf {
	/**
   ...
   */
    ...
    return SPARQLASPackage.Literals.SUB_CLASS_OF;
  }
   ...
   */
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SPARQLASPackage.SUB_CLASS_OF__SUB_CLASS_EXPRESSION, oldSubClassExpression, newSubClassExpression);
   ...
   */
    ...
    if (newSubClassExpression != subClassExpression)
    {
      ...
      if (subClassExpression != null)
        msgs = ((InternalEObject)subClassExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SPARQLASPackage.SUB_CLASS_OF__SUB_CLASS_EXPRESSION, null, msgs);
      if (newSubClassExpression != null)
        msgs = ((InternalEObject)newSubClassExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SPARQLASPackage.SUB_CLASS_OF__SUB_CLASS_EXPRESSION, null, msgs);
      msgs = basicSetSubClassExpression(newSubClassExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPARQLASPackage.SUB_CLASS_OF__SUB_CLASS_EXPRESSION, newSubClassExpression, newSubClassExpression));
  }
   ...
   */
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SPARQLASPackage.SUB_CLASS_OF__SUPER_CLASS_EXPRESSION, oldSuperClassExpression, newSuperClassExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   */
    ...
    if (newSuperClassExpression != superClassExpression)
    {
      ...
      if (superClassExpression != null)
        msgs = ((InternalEObject)superClassExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SPARQLASPackage.SUB_CLASS_OF__SUPER_CLASS_EXPRESSION, null, msgs);
      if (newSuperClassExpression != null)
        msgs = ((InternalEObject)newSuperClassExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SPARQLASPackage.SUB_CLASS_OF__SUPER_CLASS_EXPRESSION, null, msgs);
      msgs = basicSetSuperClassExpression(newSuperClassExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPARQLASPackage.SUB_CLASS_OF__SUPER_CLASS_EXPRESSION, newSuperClassExpression, newSuperClassExpression));
  }
   ...
   */
    ...
    switch (featureID)
    {
      case SPARQLASPackage.SUB_CLASS_OF__SUB_CLASS_EXPRESSION:
        return basicSetSubClassExpression(null, msgs);
      case SPARQLASPackage.SUB_CLASS_OF__SUPER_CLASS_EXPRESSION:
