...
public class Owl2fsBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource resource, final west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor) {
		if (resource == null) {
			return;
		}
