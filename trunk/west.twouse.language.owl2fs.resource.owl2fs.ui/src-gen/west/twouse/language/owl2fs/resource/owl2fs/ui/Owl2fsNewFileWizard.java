...
public class Owl2fsNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsNewFileWizardPage page;
	...
	public void addPages() {
		page = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsMetaInformation().getSyntaxName();
	}
