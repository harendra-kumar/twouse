...
public class Owl2fsOccurrencePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private void initializeValues() {
		boolean enable = getPreferenceStore().getBoolean(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		enableCheckbox.setSelection(enable);
		
		defColorButton.setEnabled(enable);
		org.eclipse.swt.graphics.RGB rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_DEFINITION_COLOR);
		defColorSelector.setColorValue(rgb);
		
		useColorButton.setEnabled(enable);
		rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_PROXY_COLOR);
	...
	protected void performDefaults() {
		boolean enable = getPreferenceStore().getDefaultBoolean(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		enableCheckbox.setSelection(enable);
		defColorButton.setEnabled(enable);
		useColorButton.setEnabled(enable);
		defColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_DEFINITION_COLOR));
		useColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_PROXY_COLOR));
	}
	...
	private void updateActiveEditor() {
		getPreferenceStore().setValue(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX, enableCheckbox.getSelection());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_DEFINITION_COLOR, defColorSelector.getColorValue());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_PROXY_COLOR, useColorSelector.getColorValue());
