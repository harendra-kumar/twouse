	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor) {
					west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor emftEditor = (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor) editorPart;
