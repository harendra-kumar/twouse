...
public class Owl2fsCodeFoldingManager {
	...
	private class FoldingUpdateListener implements west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor) {
				west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor = (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor) workbenchPart;
	...
	protected west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor;
	 ...
	 */
	public Owl2fsCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor textEditor) {
	...
	private void addCloseListener(final west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource textResource = (west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
