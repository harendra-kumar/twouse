...
public class SparqlasReferenceResolveResult<ReferenceType> implements west.twouse.language.sparqlas.resource.sparqlas.ISparqlasReferenceResolveResult<ReferenceType> {
	...
	public void addMapping(String identifier, ReferenceType target, String warning) {
		if (mappings == null) {
			mappings = new java.util.ArrayList<west.twouse.language.sparqlas.resource.sparqlas.ISparqlasReferenceMapping<ReferenceType>>();
		}
		mappings.add(new west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasElementMapping<ReferenceType>(identifier, target, warning));
		errorMessage = null;
	}
	...
	public void addMapping(String identifier, org.eclipse.emf.common.util.URI uri, String warning) {
		...
		mappings.add(new west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasURIMapping<ReferenceType>(identifier, uri, warning));
	}
}
