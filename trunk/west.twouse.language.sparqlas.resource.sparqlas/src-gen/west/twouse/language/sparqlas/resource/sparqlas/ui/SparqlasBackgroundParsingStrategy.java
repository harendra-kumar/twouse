...
public class SparqlasBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource resource, final west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor editor) {
		if (resource == null) {
			return;
		}
