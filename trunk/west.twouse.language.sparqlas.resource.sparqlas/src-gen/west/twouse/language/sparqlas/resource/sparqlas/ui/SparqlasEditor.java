...
public class SparqlasEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof west.twouse.language.sparqlas.resource.sparqlas.ISparqlasTextResource) {
					...
					west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SparqlasEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
			...
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						...
						west.twouse.language.sparqlas.resource.sparqlas.mopp.SparqlasPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
