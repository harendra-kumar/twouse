...
public class SparqlasEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor theEditor;
	...
	// @param colorManager
	///
	public SparqlasEditorConfiguration(west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasEditor editor, west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new west.twouse.language.sparqlas.resource.sparqlas.ui.SparqlasHyperlinkDetector(theEditor.getResource()) };
	}
