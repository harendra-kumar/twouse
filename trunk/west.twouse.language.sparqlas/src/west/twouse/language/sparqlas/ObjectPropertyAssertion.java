 ...
 * <ul>
 *   <li>{@link west.twouse.language.sparqlas.ObjectPropertyAssertion#getSourceIndividual <em>Source Individual</em>}</li>
 *   <li>{@link west.twouse.language.sparqlas.ObjectPropertyAssertion#getTargetIndividual <em>Target Individual</em>}</li>
 *   <li>{@link west.twouse.language.sparqlas.ObjectPropertyAssertion#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.sparqlas.SparqlasPackage#getObjectPropertyAssertion()
 * @model
 * @generated
 */
public interface ObjectPropertyAssertion extends Assertion
{
   ...
   * @see west.twouse.language.sparqlas.SparqlasPackage#getObjectPropertyAssertion_SourceIndividual()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.sparqlas.ObjectPropertyAssertion#getSourceIndividual <em>Source Individual</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.sparqlas.SparqlasPackage#getObjectPropertyAssertion_TargetIndividual()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.sparqlas.ObjectPropertyAssertion#getTargetIndividual <em>Target Individual</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.sparqlas.SparqlasPackage#getObjectPropertyAssertion_ObjectPropertyExpression()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.sparqlas.ObjectPropertyAssertion#getObjectPropertyExpression <em>Object Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
