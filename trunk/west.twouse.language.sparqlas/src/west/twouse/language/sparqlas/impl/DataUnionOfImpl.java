 ...
 * <ul>
 *   <li>{@link west.twouse.language.sparqlas.impl.DataUnionOfImpl#getDataRanges <em>Data Ranges</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataUnionOfImpl extends DataRangeImpl implements DataUnionOf
{
  ...
  {
    return SparqlasPackage.Literals.DATA_UNION_OF;
  }
  ...
  public EList<DataRange> getDataRanges()
  {
    if (dataRanges == null)
    {
      dataRanges = new EObjectContainmentEList<DataRange>(DataRange.class, this, SparqlasPackage.DATA_UNION_OF__DATA_RANGES);
    }
    return dataRanges;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SparqlasPackage.DATA_UNION_OF__DATA_RANGES:
