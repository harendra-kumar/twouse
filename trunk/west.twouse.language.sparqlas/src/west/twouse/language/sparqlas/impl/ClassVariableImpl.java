 ...
 * <ul>
 *   <li>{@link west.twouse.language.sparqlas.impl.ClassVariableImpl#getTemplateParameter <em>Template Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassVariableImpl extends VariableImpl implements ClassVariable
{
  ...
  {
    return SparqlasPackage.Literals.CLASS_VARIABLE;
  }
  ...
  {
    if (eContainerFeatureID() != SparqlasPackage.CLASS_VARIABLE__TEMPLATE_PARAMETER) return null;
  ...
  {
    msgs = eBasicSetContainer((InternalEObject)newTemplateParameter, SparqlasPackage.CLASS_VARIABLE__TEMPLATE_PARAMETER, msgs);
    return msgs;
  }
  ...
  {
    if (newTemplateParameter != eInternalContainer() || (eContainerFeatureID() != SparqlasPackage.CLASS_VARIABLE__TEMPLATE_PARAMETER && newTemplateParameter != null))
    {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, SparqlasPackage.CLASS_VARIABLE__TEMPLATE_PARAMETER, newTemplateParameter, newTemplateParameter));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SparqlasPackage.CLASS_VARIABLE__TEMPLATE_PARAMETER:
        if (eInternalContainer() != null)
          msgs = eBasicRemoveFromContainer(msgs);
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == ParameterableElement.class)
    {
      ...
      {
        case SparqlasPackage.CLASS_VARIABLE__TEMPLATE_PARAMETER: return SparqlasPackage.PARAMETERABLE_ELEMENT__TEMPLATE_PARAMETER;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == ParameterableElement.class)
    {
      ...
      {
        case SparqlasPackage.PARAMETERABLE_ELEMENT__TEMPLATE_PARAMETER: return SparqlasPackage.CLASS_VARIABLE__TEMPLATE_PARAMETER;
        default: return -1;
      }
    }
    if (baseClass == Expression.class)
