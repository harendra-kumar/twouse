...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Direct Sub Class Of</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link west.twouse.language.sparqlas.impl.DirectSubClassOfImpl#getSubClassExpression <em>Sub Class Expression</em>}</li>
 *   <li>{@link west.twouse.language.sparqlas.impl.DirectSubClassOfImpl#getSuperClassExpression <em>Super Class Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DirectSubClassOfImpl extends ClassAtomImpl implements DirectSubClassOf
{
  /**
   ...
   * @generated
   */
  protected DirectSubClassOfImpl()
  {
    super();
  }
  ...
  {
    return SparqlasPackage.Literals.DIRECT_SUB_CLASS_OF;
  }
  ...
  public NotificationChain basicSetSubClassExpression(ClassExpression newSubClassExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SparqlasPackage.DIRECT_SUB_CLASS_OF__SUB_CLASS_EXPRESSION, oldSubClassExpression, newSubClassExpression);
  ...
  public void setSubClassExpression(ClassExpression newSubClassExpression)
  {
    if (newSubClassExpression != subClassExpression)
    {
      ...
      if (subClassExpression != null)
        msgs = ((InternalEObject)subClassExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SparqlasPackage.DIRECT_SUB_CLASS_OF__SUB_CLASS_EXPRESSION, null, msgs);
      if (newSubClassExpression != null)
        msgs = ((InternalEObject)newSubClassExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SparqlasPackage.DIRECT_SUB_CLASS_OF__SUB_CLASS_EXPRESSION, null, msgs);
      msgs = basicSetSubClassExpression(newSubClassExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparqlasPackage.DIRECT_SUB_CLASS_OF__SUB_CLASS_EXPRESSION, newSubClassExpression, newSubClassExpression));
  }
  ...
  public NotificationChain basicSetSuperClassExpression(ClassExpression newSuperClassExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SparqlasPackage.DIRECT_SUB_CLASS_OF__SUPER_CLASS_EXPRESSION, oldSuperClassExpression, newSuperClassExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setSuperClassExpression(ClassExpression newSuperClassExpression)
  {
    if (newSuperClassExpression != superClassExpression)
    {
      ...
      if (superClassExpression != null)
        msgs = ((InternalEObject)superClassExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SparqlasPackage.DIRECT_SUB_CLASS_OF__SUPER_CLASS_EXPRESSION, null, msgs);
      if (newSuperClassExpression != null)
        msgs = ((InternalEObject)newSuperClassExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SparqlasPackage.DIRECT_SUB_CLASS_OF__SUPER_CLASS_EXPRESSION, null, msgs);
      msgs = basicSetSuperClassExpression(newSuperClassExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparqlasPackage.DIRECT_SUB_CLASS_OF__SUPER_CLASS_EXPRESSION, newSuperClassExpression, newSuperClassExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SparqlasPackage.DIRECT_SUB_CLASS_OF__SUB_CLASS_EXPRESSION:
        return basicSetSubClassExpression(null, msgs);
      case SparqlasPackage.DIRECT_SUB_CLASS_OF__SUPER_CLASS_EXPRESSION:
