 ...
 * @generated
 */
public class SparqlmsAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected SparqlmsSwitch<Adapter> modelSwitch =
    new SparqlmsSwitch<Adapter>()
    {
      @Override
