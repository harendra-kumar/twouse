 ...
 * <ul>
 *   <li>{@link west.twouse.language.sparqlas.ObjectAllValuesFrom#getClassExpression <em>Class Expression</em>}</li>
 *   <li>{@link west.twouse.language.sparqlas.ObjectAllValuesFrom#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.sparqlas.SparqlasPackage#getObjectAllValuesFrom()
 * @model
 * @generated
 */
public interface ObjectAllValuesFrom extends ClassExpression {
   ...
   * @see west.twouse.language.sparqlas.SparqlasPackage#getObjectAllValuesFrom_ClassExpression()
   ...
   */
	...
	/**
   * Sets the value of the '{@link west.twouse.language.sparqlas.ObjectAllValuesFrom#getClassExpression <em>Class Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.sparqlas.SparqlasPackage#getObjectAllValuesFrom_ObjectPropertyExpression()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link west.twouse.language.sparqlas.ObjectAllValuesFrom#getObjectPropertyExpression <em>Object Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
