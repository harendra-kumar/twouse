...
public class SparqlasBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ISparqlasTextResource resource, final de.uniko.isweb.emftext.sparqlas.SPARQLAS.resource.sparqlas.ui.SparqlasEditor editor) {
		if (resource == null) {
			return;
		}
