...
public class Owl2fsTextResourceUtil {
	...
	public static west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsResource) csResource;
	}
	
	public static west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsResource getResource(java.io.File file) {
		return getResource(file, null);
	}
	
	public static west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsResource getResource(java.io.File file, java.util.Map<?,?> options) {
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
