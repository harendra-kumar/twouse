...
public class Owl2fsBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private String BRACKETS_COLOR = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsMetaInformation().getSyntaxName();
	
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBracketSet bracketsTmp;
	...
	public Owl2fsBracketPreferencePage() {
		...
		west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsMetaInformation metaInformation = new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(		west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(		language + west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor) {
			((west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor) editor).invalidateTextRepresentation();
		}
	}
