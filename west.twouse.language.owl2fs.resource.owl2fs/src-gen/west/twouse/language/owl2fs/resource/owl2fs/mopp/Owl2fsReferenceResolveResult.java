...
public class Owl2fsReferenceResolveResult<ReferenceType> implements west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsReferenceResolveResult<ReferenceType> {
	...
	public void addMapping(String identifier, ReferenceType target, String warning) {
		if (mappings == null) {
			mappings = new java.util.ArrayList<west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsReferenceMapping<ReferenceType>>();
		}
		mappings.add(new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsElementMapping<ReferenceType>(identifier, target, warning));
		errorMessage = null;
	}
	...
	public void addMapping(String identifier, org.eclipse.emf.common.util.URI uri, String warning) {
		...
		mappings.add(new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsURIMapping<ReferenceType>(identifier, uri, warning));
	}
}
