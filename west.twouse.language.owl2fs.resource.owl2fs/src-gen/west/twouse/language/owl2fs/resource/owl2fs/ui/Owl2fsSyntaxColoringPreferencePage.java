...
public class Owl2fsSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPixelConverter pixelConverter = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsPixelConverter(composite);
	...
	public Owl2fsSyntaxColoringPreferencePage() {
		...
		west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsMetaInformation syntaxPlugin = new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor) {
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor emfTextEditor = (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor) editor;
