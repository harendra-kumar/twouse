...
public class Owl2fsTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl infoControl) {
		...
		public void run() {
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput infoInput = (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHyperlink hyperlink = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl iControl = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) {
							west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput input = (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl.isAvailable(parent)) {
				west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl iControl = new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public Owl2fsTextHover(west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource textResource = editor.getResource();
	...
	private west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.insertPageProlog(buffer, 0, west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsTextHover.getStyleSheet());
			west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.addPageEpilog(buffer);
			return new west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = west.twouse.language.owl2fs.resource.owl2fs.ui.Owl2fsHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.PLUGIN_ID);
