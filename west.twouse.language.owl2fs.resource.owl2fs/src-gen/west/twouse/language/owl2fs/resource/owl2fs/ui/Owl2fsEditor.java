...
public class Owl2fsEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTextResource) {
					...
					west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the Owl2fsEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
			...
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						...
						west.twouse.language.owl2fs.resource.owl2fs.mopp.Owl2fsPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
