 ...
 * instance of Owl2fsDefaultTokenResolver which performs a standard conversion
 * based on the EMF type conversion. This includes conversion of registered
 * EDataTypes.
 * 
 * @see
 * west.twouse.language.owl2fs.resource.owl2fs.analysis.Owl2fsDefaultTokenResolver
 */
public interface IOwl2fsTokenResolver extends west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsConfigurable {
	 ...
	 * errors
	 */
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, west.twouse.language.owl2fs.resource.owl2fs.IOwl2fsTokenResolveResult result);
