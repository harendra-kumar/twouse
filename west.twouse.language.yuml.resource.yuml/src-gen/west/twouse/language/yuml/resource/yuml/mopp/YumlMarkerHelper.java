 ...
 * contains
 * <code>west.twouse.language.yuml.resource.yuml.IYumlTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class YumlMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = west.twouse.language.yuml.resource.yuml.mopp.YumlPlugin.PLUGIN_ID + ".problem";
	/**
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final west.twouse.language.yuml.resource.yuml.IYumlTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(org.eclipse.core.resources.IFile file, final west.twouse.language.yuml.resource.yuml.IYumlTextDiagnostic diagnostic) {
		try {
			...
			if (diagnostic.getProblem().getType() == west.twouse.language.yuml.resource.yuml.YumlEProblemType.ERROR) {
			...
			west.twouse.language.yuml.resource.yuml.IYumlTextDiagnostic textDiagnostic = (west.twouse.language.yuml.resource.yuml.IYumlTextDiagnostic) diagnostic;
			...
			java.util.Collection<west.twouse.language.yuml.resource.yuml.IYumlQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
			...
			if (!sourceIDs.isEmpty()) {
				marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, west.twouse.language.yuml.resource.yuml.util.YumlStringUtil.explode(sourceIDs, "|"));
			}
		} catch (org.eclipse.core.runtime.CoreException ce) {
			if (ce.getMessage().matches("Marker.*not found.")) {
				// ignore
			} else {
				west.twouse.language.yuml.resource.yuml.mopp.YumlPlugin.logError("Error marking resource:", ce);
			}
		}
	}
