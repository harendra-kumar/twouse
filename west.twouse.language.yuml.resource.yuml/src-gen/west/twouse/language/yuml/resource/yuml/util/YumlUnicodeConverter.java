 ...
 * to 4 bytes).
 */
public class YumlUnicodeConverter extends west.twouse.language.yuml.resource.yuml.mopp.YumlInputStreamProcessor {
	 ...
	 */
	public YumlUnicodeConverter(java.io.InputStream inputStream) {
