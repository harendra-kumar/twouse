...
/**
 * A IYumlReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IYumlReferenceResolverSwitch extends west.twouse.language.yuml.resource.yuml.IYumlConfigurable {
