...
public class YumlLayoutInformation {
	
	private final west.twouse.language.yuml.resource.yuml.grammar.YumlSyntaxElement syntaxElement;
	...
	public YumlLayoutInformation(west.twouse.language.yuml.resource.yuml.grammar.YumlSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public west.twouse.language.yuml.resource.yuml.grammar.YumlSyntaxElement getSyntaxElement() {
