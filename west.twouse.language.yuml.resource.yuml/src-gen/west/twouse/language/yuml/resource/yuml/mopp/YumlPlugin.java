 ...
 */
public class YumlPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "west.twouse.language.yuml.resource.yuml";
	/**
	...
	private static YumlPlugin plugin;
	...
	public static YumlPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, YumlPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, YumlPlugin.PLUGIN_ID, message);
		}
		final YumlPlugin pluginInstance = YumlPlugin.getDefault();
