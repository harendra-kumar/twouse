 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.DataExactCardinality#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.DataExactCardinality#getDataRange <em>Data Range</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.DataExactCardinality#getDataPropertyExpression <em>Data Property Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataExactCardinality()
 * @model
 * @generated
 */
public interface DataExactCardinality extends ClassExpression, Expression
{
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataExactCardinality_Cardinality()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.DataExactCardinality#getCardinality <em>Cardinality</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataExactCardinality_DataRange()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.DataExactCardinality#getDataRange <em>Data Range</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataExactCardinality_DataPropertyExpression()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.DataExactCardinality#getDataPropertyExpression <em>Data Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
