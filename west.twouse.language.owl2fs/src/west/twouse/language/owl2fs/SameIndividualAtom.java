 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.SameIndividualAtom#getIArg1 <em>IArg1</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.SameIndividualAtom#getIArg2 <em>IArg2</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getSameIndividualAtom()
 * @model
 * @generated
 */
public interface SameIndividualAtom extends Atom
{
   ...
   * @see #setIArg1(IArg)
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getSameIndividualAtom_IArg1()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.SameIndividualAtom#getIArg1 <em>IArg1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setIArg2(IArg)
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getSameIndividualAtom_IArg2()
   * @model containment="true" required="true"
   * @generated
   */
  IArg getIArg2();
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.SameIndividualAtom#getIArg2 <em>IArg2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
