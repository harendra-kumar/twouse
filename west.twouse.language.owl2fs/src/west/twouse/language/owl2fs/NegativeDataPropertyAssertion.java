 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.NegativeDataPropertyAssertion#getDataPropertyExpression <em>Data Property Expression</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.NegativeDataPropertyAssertion#getTargetValue <em>Target Value</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.NegativeDataPropertyAssertion#getSourceIndividual <em>Source Individual</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getNegativeDataPropertyAssertion()
 * @model
 * @generated
 */
public interface NegativeDataPropertyAssertion extends Assertion
{
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getNegativeDataPropertyAssertion_DataPropertyExpression()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.NegativeDataPropertyAssertion#getDataPropertyExpression <em>Data Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getNegativeDataPropertyAssertion_TargetValue()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.NegativeDataPropertyAssertion#getTargetValue <em>Target Value</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getNegativeDataPropertyAssertion_SourceIndividual()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.NegativeDataPropertyAssertion#getSourceIndividual <em>Source Individual</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
