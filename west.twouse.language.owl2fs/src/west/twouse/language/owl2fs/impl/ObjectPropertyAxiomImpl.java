 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.impl.ObjectPropertyAxiomImpl#getAxiomAnnotations <em>Axiom Annotations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ObjectPropertyAxiomImpl extends AxiomImpl implements ObjectPropertyAxiom
{
  ...
  {
    return Owl2fsPackage.Literals.OBJECT_PROPERTY_AXIOM;
  }
  ...
  public EList<Annotation> getAxiomAnnotations()
  {
    ...
    {
      axiomAnnotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, Owl2fsPackage.OBJECT_PROPERTY_AXIOM__AXIOM_ANNOTATIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Owl2fsPackage.OBJECT_PROPERTY_AXIOM__AXIOM_ANNOTATIONS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == AnnotationAxiom.class)
    {
      ...
      {
        case Owl2fsPackage.OBJECT_PROPERTY_AXIOM__AXIOM_ANNOTATIONS: return Owl2fsPackage.ANNOTATION_AXIOM__AXIOM_ANNOTATIONS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == AnnotationAxiom.class)
    {
      ...
      {
        case Owl2fsPackage.ANNOTATION_AXIOM__AXIOM_ANNOTATIONS: return Owl2fsPackage.OBJECT_PROPERTY_AXIOM__AXIOM_ANNOTATIONS;
        default: return -1;
      }
    }
