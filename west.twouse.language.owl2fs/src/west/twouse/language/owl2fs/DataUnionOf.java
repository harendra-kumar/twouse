 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.DataUnionOf#getDataRange <em>Data Range</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataUnionOf()
 * @model
 * @generated
 */
public interface DataUnionOf extends DataRange, Expression
{
  /**
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataUnionOf_DataRange()
