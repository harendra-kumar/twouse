 ...
 * <ul>
 *   <li>{@link west.twouse.language.owl2fs.DataPropertyRange#getRange <em>Range</em>}</li>
 *   <li>{@link west.twouse.language.owl2fs.DataPropertyRange#getDataPropertyExpression <em>Data Property Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataPropertyRange()
 * @model
 * @generated
 */
public interface DataPropertyRange extends DataPropertyAxiom
{
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataPropertyRange_Range()
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.DataPropertyRange#getRange <em>Range</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see west.twouse.language.owl2fs.Owl2fsPackage#getDataPropertyRange_DataPropertyExpression()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link west.twouse.language.owl2fs.DataPropertyRange#getDataPropertyExpression <em>Data Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
