 ...
 * hovers, is a proxy.
 */
public class YumlHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public YumlHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (west.twouse.language.yuml.resource.yuml.IYumlTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new west.twouse.language.yuml.resource.yuml.ui.YumlHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
