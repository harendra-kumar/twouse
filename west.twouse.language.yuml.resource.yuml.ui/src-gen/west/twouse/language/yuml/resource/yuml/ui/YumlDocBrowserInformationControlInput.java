 ...
 * olInput</code>.
 */
public class YumlDocBrowserInformationControlInput {
	
	private final YumlDocBrowserInformationControlInput fPrevious;
	private YumlDocBrowserInformationControlInput fNext;
	 ...
	 */
	public YumlDocBrowserInformationControlInput(YumlDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public YumlDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public YumlDocBrowserInformationControlInput getNext() {
		return fNext;
	}
