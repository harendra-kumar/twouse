 ...
 * @since 3.2
 */
public class YumlBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput fInput;
	 ...
	 */
	public YumlBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public YumlBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public YumlBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput);
		...
		fInput= (west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput) input;
		...
		west.twouse.language.yuml.resource.yuml.ui.YumlHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = west.twouse.language.yuml.resource.yuml.ui.YumlHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput getInput() {
		return fInput;
	}
