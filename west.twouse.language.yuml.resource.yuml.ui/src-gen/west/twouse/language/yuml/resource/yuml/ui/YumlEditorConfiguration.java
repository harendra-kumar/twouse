 ...
 */
public class YumlEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	
	private west.twouse.language.yuml.resource.yuml.ui.YumlColorManager colorManager;
	private west.twouse.language.yuml.resource.yuml.ui.YumlEditor theEditor;
	private west.twouse.language.yuml.resource.yuml.ui.YumlQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public YumlEditorConfiguration(west.twouse.language.yuml.resource.yuml.ui.YumlEditor editor, west.twouse.language.yuml.resource.yuml.ui.YumlColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new west.twouse.language.yuml.resource.yuml.ui.YumlCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner(String fileName) {
		return new west.twouse.language.yuml.resource.yuml.ui.YumlTokenScanner(theEditor.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new west.twouse.language.yuml.resource.yuml.ui.YumlTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new west.twouse.language.yuml.resource.yuml.ui.YumlHyperlinkDetector(theEditor.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new west.twouse.language.yuml.resource.yuml.ui.YumlQuickAssistAssistant(theEditor);
		}
