...
public class YumlPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof west.twouse.language.yuml.resource.yuml.ui.YumlEObjectSelection) {
			final west.twouse.language.yuml.resource.yuml.ui.YumlEObjectSelection selection = (west.twouse.language.yuml.resource.yuml.ui.YumlEObjectSelection) iSelection;
