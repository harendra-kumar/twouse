 ...
 */
public class YumlCompletionProposal implements java.lang.Comparable<YumlCompletionProposal> {
	...
	public YumlCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public YumlCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public YumlCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof YumlCompletionProposal) {
			YumlCompletionProposal other = (YumlCompletionProposal) object;
	...
	public int compareTo(YumlCompletionProposal object) {
		if (object instanceof YumlCompletionProposal) {
			YumlCompletionProposal other = (YumlCompletionProposal) object;
