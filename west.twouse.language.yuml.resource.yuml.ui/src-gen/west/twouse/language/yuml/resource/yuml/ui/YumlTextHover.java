 ...
 */
public class YumlTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private west.twouse.language.yuml.resource.yuml.IYumlHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final west.twouse.language.yuml.resource.yuml.ui.YumlBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(west.twouse.language.yuml.resource.yuml.ui.YumlBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput infoInput = (west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					west.twouse.language.yuml.resource.yuml.ui.YumlHyperlink hyperlink = new west.twouse.language.yuml.resource.yuml.ui.YumlHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (west.twouse.language.yuml.resource.yuml.ui.YumlBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				west.twouse.language.yuml.resource.yuml.ui.YumlBrowserInformationControl iControl = new west.twouse.language.yuml.resource.yuml.ui.YumlBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput) {
							west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput input = (west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (west.twouse.language.yuml.resource.yuml.ui.YumlBrowserInformationControl.isAvailable(parent)) {
				west.twouse.language.yuml.resource.yuml.ui.YumlBrowserInformationControl iControl = new west.twouse.language.yuml.resource.yuml.ui.YumlBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public YumlTextHover(west.twouse.language.yuml.resource.yuml.ui.YumlEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new west.twouse.language.yuml.resource.yuml.ui.YumlUIMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		west.twouse.language.yuml.resource.yuml.IYumlTextResource textResource = editor.getResource();
	 ...
	 */
	private west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				west.twouse.language.yuml.resource.yuml.ui.YumlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			west.twouse.language.yuml.resource.yuml.ui.YumlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			west.twouse.language.yuml.resource.yuml.ui.YumlHTMLPrinter.insertPageProlog(buffer, 0, west.twouse.language.yuml.resource.yuml.ui.YumlTextHover.getStyleSheet());
			west.twouse.language.yuml.resource.yuml.ui.YumlHTMLPrinter.addPageEpilog(buffer);
			return new west.twouse.language.yuml.resource.yuml.ui.YumlDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = west.twouse.language.yuml.resource.yuml.ui.YumlHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(west.twouse.language.yuml.resource.yuml.ui.YumlUIPlugin.PLUGIN_ID);
