...
public class YumlNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private west.twouse.language.yuml.resource.yuml.ui.YumlNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public YumlNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new west.twouse.language.yuml.resource.yuml.ui.YumlNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			west.twouse.language.yuml.resource.yuml.ui.YumlUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			west.twouse.language.yuml.resource.yuml.ui.YumlUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new west.twouse.language.yuml.resource.yuml.mopp.YumlMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new west.twouse.language.yuml.resource.yuml.mopp.YumlMetaInformation().getSyntaxName();
	}
