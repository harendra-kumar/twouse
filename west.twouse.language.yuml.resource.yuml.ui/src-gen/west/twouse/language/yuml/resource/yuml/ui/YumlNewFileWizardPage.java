 ...
 */
public class YumlNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public YumlNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new yuml file");
