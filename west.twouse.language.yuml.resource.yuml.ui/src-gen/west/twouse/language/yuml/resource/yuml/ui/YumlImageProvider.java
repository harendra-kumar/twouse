 ...
 */
public class YumlImageProvider {
	
	public final static YumlImageProvider INSTANCE = new YumlImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor desriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(west.twouse.language.yuml.resource.yuml.ui.YumlUIPlugin.getDefault().getBundle(), path, null));
