 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DisjointUnionImpl#getUnionClass <em>Union Class</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DisjointUnionImpl#getDisjointClassExpressions <em>Disjoint Class Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DisjointUnionImpl extends ClassAxiomImpl implements DisjointUnion
{
   ...
   * @ordered
   */
  protected de.uniko.isweb.emftext.owl2fs.owl2fs.Class unionClass;
   ...
   * @generated
   */
  public de.uniko.isweb.emftext.owl2fs.owl2fs.Class getUnionClass()
  {
    return unionClass;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetUnionClass(de.uniko.isweb.emftext.owl2fs.owl2fs.Class newUnionClass, NotificationChain msgs)
  {
    de.uniko.isweb.emftext.owl2fs.owl2fs.Class oldUnionClass = unionClass;
   ...
   * @generated
   */
  public void setUnionClass(de.uniko.isweb.emftext.owl2fs.owl2fs.Class newUnionClass)
  {
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case Owl2fsPackage.DISJOINT_UNION__UNION_CLASS:
        setUnionClass((de.uniko.isweb.emftext.owl2fs.owl2fs.Class)newValue);
        return;
      case Owl2fsPackage.DISJOINT_UNION__DISJOINT_CLASS_EXPRESSIONS:
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case Owl2fsPackage.DISJOINT_UNION__UNION_CLASS:
        setUnionClass((de.uniko.isweb.emftext.owl2fs.owl2fs.Class)null);
        return;
      case Owl2fsPackage.DISJOINT_UNION__DISJOINT_CLASS_EXPRESSIONS:
        getDisjointClassExpressions().clear();
        return;
