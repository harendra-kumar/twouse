 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.ObjectSomeValuesFrom#getClassExpression <em>Class Expression</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.ObjectSomeValuesFrom#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getObjectSomeValuesFrom()
 * @model
 * @generated
 */
public interface ObjectSomeValuesFrom extends ClassExpression, Expression
{
  /**
   ...
   * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getObjectSomeValuesFrom_ClassExpression()
  ...
  /**
   * Sets the value of the '{@link de.uniko.isweb.emftext.owl2fs.owl2fs.ObjectSomeValuesFrom#getClassExpression <em>Class Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getObjectSomeValuesFrom_ObjectPropertyExpression()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uniko.isweb.emftext.owl2fs.owl2fs.ObjectSomeValuesFrom#getObjectPropertyExpression <em>Object Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
