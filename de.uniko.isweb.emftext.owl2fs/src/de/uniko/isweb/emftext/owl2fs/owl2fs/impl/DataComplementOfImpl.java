 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DataComplementOfImpl#getDataRange <em>Data Range</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataComplementOfImpl extends DataRangeImpl implements DataComplementOf
{
  ...
  {
    return Owl2fsPackage.Literals.DATA_COMPLEMENT_OF;
  }
  ...
  public NotificationChain basicSetDataRange(DataRange newDataRange, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DATA_COMPLEMENT_OF__DATA_RANGE, oldDataRange, newDataRange);
  ...
  public void setDataRange(DataRange newDataRange)
  {
    if (newDataRange != dataRange)
    {
      ...
      if (dataRange != null)
        msgs = ((InternalEObject)dataRange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.DATA_COMPLEMENT_OF__DATA_RANGE, null, msgs);
      if (newDataRange != null)
        msgs = ((InternalEObject)newDataRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.DATA_COMPLEMENT_OF__DATA_RANGE, null, msgs);
      msgs = basicSetDataRange(newDataRange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DATA_COMPLEMENT_OF__DATA_RANGE, newDataRange, newDataRange));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Owl2fsPackage.DATA_COMPLEMENT_OF__DATA_RANGE:
