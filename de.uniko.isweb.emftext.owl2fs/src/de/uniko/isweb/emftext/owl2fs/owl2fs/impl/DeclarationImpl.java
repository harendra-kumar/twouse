 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DeclarationImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DeclarationImpl#isIsFunctional <em>Is Functional</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DeclarationImpl#isIsReflexive <em>Is Reflexive</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DeclarationImpl#isIsInverseFunctional <em>Is Inverse Functional</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DeclarationImpl#isIsIrreflexive <em>Is Irreflexive</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DeclarationImpl#isIsSymmetric <em>Is Symmetric</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DeclarationImpl#isIsTransitive <em>Is Transitive</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DeclarationImpl#isIsAsysmmetric <em>Is Asysmmetric</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeclarationImpl extends AxiomImpl implements Declaration
{
  ...
  public void setIsFunctional(boolean newIsFunctional)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DECLARATION__IS_FUNCTIONAL, oldIsFunctional, isFunctional));
  }
  ...
  public void setIsReflexive(boolean newIsReflexive)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DECLARATION__IS_REFLEXIVE, oldIsReflexive, isReflexive));
  }
  ...
  public void setIsInverseFunctional(boolean newIsInverseFunctional)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DECLARATION__IS_INVERSE_FUNCTIONAL, oldIsInverseFunctional, isInverseFunctional));
  }
  ...
  public void setIsIrreflexive(boolean newIsIrreflexive)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DECLARATION__IS_IRREFLEXIVE, oldIsIrreflexive, isIrreflexive));
  }
  ...
  public void setIsSymmetric(boolean newIsSymmetric)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DECLARATION__IS_SYMMETRIC, oldIsSymmetric, isSymmetric));
  }
  ...
  public void setIsTransitive(boolean newIsTransitive)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DECLARATION__IS_TRANSITIVE, oldIsTransitive, isTransitive));
  }
  ...
  public void setIsAsysmmetric(boolean newIsAsysmmetric)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DECLARATION__IS_ASYSMMETRIC, oldIsAsysmmetric, isAsysmmetric));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Owl2fsPackage.DECLARATION__ENTITY:
        return getEntity();
      case Owl2fsPackage.DECLARATION__IS_FUNCTIONAL:
        return isIsFunctional();
      case Owl2fsPackage.DECLARATION__IS_REFLEXIVE:
        return isIsReflexive();
      case Owl2fsPackage.DECLARATION__IS_INVERSE_FUNCTIONAL:
        return isIsInverseFunctional();
      case Owl2fsPackage.DECLARATION__IS_IRREFLEXIVE:
        return isIsIrreflexive();
      case Owl2fsPackage.DECLARATION__IS_SYMMETRIC:
        return isIsSymmetric();
      case Owl2fsPackage.DECLARATION__IS_TRANSITIVE:
        return isIsTransitive();
      case Owl2fsPackage.DECLARATION__IS_ASYSMMETRIC:
