 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DataSomeValuesFromImpl#getDataRange <em>Data Range</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.impl.DataSomeValuesFromImpl#getDataPropertyExpressions <em>Data Property Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataSomeValuesFromImpl extends ClassExpressionImpl implements DataSomeValuesFrom
{
  ...
  {
    return Owl2fsPackage.Literals.DATA_SOME_VALUES_FROM;
  }
  ...
  public NotificationChain basicSetDataRange(DataRange newDataRange, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_RANGE, oldDataRange, newDataRange);
  ...
  public void setDataRange(DataRange newDataRange)
  {
    if (newDataRange != dataRange)
    {
      ...
      if (dataRange != null)
        msgs = ((InternalEObject)dataRange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_RANGE, null, msgs);
      if (newDataRange != null)
        msgs = ((InternalEObject)newDataRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_RANGE, null, msgs);
      msgs = basicSetDataRange(newDataRange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_RANGE, newDataRange, newDataRange));
  }
  ...
  public NotificationChain basicSetDataPropertyExpressions(DataPropertyExpression newDataPropertyExpressions, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTY_EXPRESSIONS, oldDataPropertyExpressions, newDataPropertyExpressions);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDataPropertyExpressions(DataPropertyExpression newDataPropertyExpressions)
  {
    if (newDataPropertyExpressions != dataPropertyExpressions)
    {
      ...
      if (dataPropertyExpressions != null)
        msgs = ((InternalEObject)dataPropertyExpressions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTY_EXPRESSIONS, null, msgs);
      if (newDataPropertyExpressions != null)
        msgs = ((InternalEObject)newDataPropertyExpressions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTY_EXPRESSIONS, null, msgs);
      msgs = basicSetDataPropertyExpressions(newDataPropertyExpressions, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTY_EXPRESSIONS, newDataPropertyExpressions, newDataPropertyExpressions));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_RANGE:
        return basicSetDataRange(null, msgs);
      case Owl2fsPackage.DATA_SOME_VALUES_FROM__DATA_PROPERTY_EXPRESSIONS:
