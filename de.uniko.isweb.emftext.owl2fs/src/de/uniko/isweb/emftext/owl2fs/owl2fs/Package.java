 ...
 * <ul>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.Package#getExpressions <em>Expressions</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.Package#getAxioms <em>Axioms</em>}</li>
 *   <li>{@link de.uniko.isweb.emftext.owl2fs.owl2fs.Package#getPackageUri <em>Package Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getPackage()
 * @model
 * @generated
 */
public interface Package extends TemplateableElement
{
   ...
   * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getPackage_Expressions()
   ...
   * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getPackage_Axioms()
   * @model containment="true" ordered="false"
   * @generated
   */
   ...
   * @see de.uniko.isweb.emftext.owl2fs.owl2fs.Owl2fsPackage#getPackage_PackageUri()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uniko.isweb.emftext.owl2fs.owl2fs.Package#getPackageUri <em>Package Uri</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
